// just a UI component; comment out for now
...
namespace Gma.UserActivityMonitor {
	/// <summary>This component monitors all mouse activities globally (also outside of the application) and provides
	///     appropriate events.</summary>
	public class GlobalEventProvider : Component {
		/// <summary>This component raises events. The value is always true.</summary>
		protected override bool CanRaiseEvents { get { return true; } }

		//################################################################

		#region Mouse events
		event MouseEventHandler m_MouseMove;
		...
		event MouseEventHandler m_MouseClick;
		/// <summary>Occurs when a click was performed by the mouse.</summary>
		...
		event MouseEventHandler m_MouseDown;

		/// <summary>Occurs when the mouse a mouse button is pressed.</summary>
		...
		event MouseEventHandler m_MouseUp;
		...
		event MouseEventHandler m_MouseDoubleClick;

		/// <summary>Occurs when a double clicked was performed by the mouse.</summary>
		...
		event EventHandler<MouseEventExtArgs> m_MouseMoveExt;

		/// <summary>Occurs when the mouse pointer is moved.</summary>
		/// <remarks>This event provides extended arguments of type <see cref = "MouseEventArgs" /> enabling you to supress further
		///     processing of mouse movement in other applications.</remarks>
		...
		event EventHandler<MouseEventExtArgs> m_MouseClickExt;

		/// <summary>Occurs when a click was performed by the mouse.</summary>
		/// <remarks>This event provides extended arguments of type <see cref = "MouseEventArgs" /> enabling you to supress further
		///     processing of mouse click in other applications.</remarks>
		...
		event KeyPressEventHandler m_KeyPress;
		...
		///     KeyUp events. Use the KeyChar property to sample keystrokes at run time and to consume or modify a subset of common
		///     keystrokes. To handle keyboard events only in your application and not enable other applications to receive
		///     keyboard events, set the KeyPressEventArgs.Handled property in your form's KeyPress event-handling method to
		///     <b>true</b>.</remarks>
		...
		event KeyEventHandler m_KeyDown;
		...
		void HookManager_KeyDown(object sender, KeyEventArgs e) { m_KeyDown.Invoke(this, e); }
		#endregion
	}
}*/
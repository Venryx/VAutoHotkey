...
namespace Gma.UserActivityMonitor {
	...
	public static partial class HookManager {
		...
		static event EventHandler<MouseEventExtArgs> s_MouseMoveExt;
		...
		static event MouseEventHandler s_MouseClick;
		...
		static event EventHandler<MouseEventExtArgs> s_MouseClickExt;
		...
		static event MouseEventHandler s_MouseDown;
		...
		static event MouseEventHandler s_MouseUp;
		...
		static event MouseEventHandler s_MouseWheel;
		...
		static event MouseEventHandler s_MouseDoubleClick;
		...
		static MouseButtons s_PrevClickedButton;
		//The timer to monitor time interval between two clicks.
		static Timer s_DoubleClickTimer;

		static void DoubleClickTimeElapsed(object sender, EventArgs e) {
			//Timer is alapsed and no second click ocuured
			s_DoubleClickTimer.Enabled = false;
			s_PrevClickedButton = MouseButtons.None;
		}

		/// <summary>This method is designed to monitor mouse clicks in order to fire a double click event if interval between
		///     clicks was short enaugh.</summary>
		...
		static event KeyEventHandler s_KeyUp;
